...
/*
		Note: Made any occurrences of 'OrgID' to 'OrgId' to be consistent.
 		And associated the GetSampleData function to a pointer to
		the OriginalDataProvider object. This will help me separate original
		data and mocktest data.
*/ 
...
func GenerateData() []*Folder {
	...
	for i := 1; i < dataSetSize; i++ {
		...
		if i%3 == 0 {	// Every 3rd orgId will be different
...
func (p *OriginalDataProvider) GetSampleData() []*Folder {
